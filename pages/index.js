...
<div className="  uk-card uk-card-default uk-grid-collapse uk-child-width-1-2@s uk-margin uk-grid" uk-grid="true">
        ...
        <div>
            <div className="uk-card-body">
                ...
                <p>{post.tanggal}</p>
                <p>{post.excerpt}</p>
                <Link href={"/post/" + post.title_slug}>
                    <a className="uk-align-right uk-button uk-button-secondary uk-width-1-4">Read More</a>
                    </Link>
            </div>
        </div>
